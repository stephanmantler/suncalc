...
function toJulian(date: DateTime): number { return date.valueOf() / dayMs - 0.5 + J1970; }
function fromJulian(j: number): DateTime  { return DateTime.fromMillis((j + 0.5 - J1970) * dayMs, { zone: "utc"}); }
function toDays(date: DateTime): number   { return toJulian(date) - J2000; }
...
function hoursLater(date: DateTime, h: number): DateTime {
